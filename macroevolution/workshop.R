# Check -- have you downloaded the GitHub repository?
# Check -- is your R studio environment functional?

# Let's load our libraries
# Mind any red messages -- some are harmless but look for errors
# Install missing packages with something like: install.packages("dplyr")
library(caper)
library(geiger)
library(stringr)
library(phytools)
...
## set up working directory, replace path with your own path -- find where you downloaded the GitHub
...
# Function from Jetz et al. (2012), also see Harvey et al. (2016)
